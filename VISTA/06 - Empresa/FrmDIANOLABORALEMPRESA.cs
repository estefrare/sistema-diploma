...
namespace VISTA
{
    public partial class FrmDIANOLABORALEMPRESA : Form
    {
       CONTROLADORA.cDATOSEMPRESA cDATOSEMPRESA;
        MODELO.DATOS_EMPRESA oDATOSEMPRESA;
        MODELO.DIAS_NO_LABORABLES oDIANOLABORABLE;
        string ACCION;
        public FrmDIANOLABORALEMPRESA(MODELO.DIAS_NO_LABORABLES miDIA, string miACCION, MODELO.DATOS_EMPRESA miDATOS)
        {
            InitializeComponent();

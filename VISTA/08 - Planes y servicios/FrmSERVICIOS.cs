...
namespace VISTA
{
    public partial class FrmSERVICIOS : Form
    {
        ...
        string accion;
        public FrmSERVICIOS(MODELO.SERVICIO miServicio, string miaccion)
        {
            InitializeComponent();
        ...
        private void MtbFechaCreacionServicio_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)(Keys.Enter))
            {
                btnGuardarServicio_Click(sender, e);
            }
        }
    }
}
